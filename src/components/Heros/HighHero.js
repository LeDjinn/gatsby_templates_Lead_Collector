...
import HighNavbar from '../Navbars/HighNavbar';

const HighHero = () => {
  return (
    <header class="bg-gray-900 pattern h-96">
      <div class="container px-6 mx-auto">
        {/* <nav class="flex flex-col py-2 sm:flex-row sm:justify-between sm:items-center">
          ...
          <div class="flex items-center mt-2 -mx-2 sm:mt-0">
            <a
              href="#"
              class="px-3 py-1 text-sm font-semibold text-white transition-colors duration-200 transform border-2 rounded-md hover:bg-gray-700"
            >
              Sign In
            </a>
            <a
              href="#"
              class="px-3 py-2 mx-2 text-sm font-semibold text-white transition-colors duration-200 transform bg-black rounded-md hover:bg-gray-800"
            >
              Sign Up
            </a>
          </div>
        ...
        <div class="flex flex-col items-center py-6 lg:h-128 lg:flex-row">
          <div class="lg:w-1/2">
            <h2 class="text-4xl font-semibold text-gray-100">Le Blog High-Tech</h2>
