  ...
  return (
    <div className="bg-gray-100">
      <div className="mt-2 py-2 bg-white">
        <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl text-blue-300 mb-8 z-40">
          Choississez la catégorie d'article qui vous convient:
        </h2>
      ...
      <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="absolute inset-x-0 top-0 items-center justify-center hidden overflow-hidden md:flex md:inset-y-0">
          <svg viewBox="0 0 88 88" className="w-full max-w-screen-xl text-blue-300">
          ...
          <div className="flex flex-col justify-between overflow-hidden text-left transition-shadow duration-200 bg-white rounded shadow-xl group hover:shadow-2xl">
            <div className="p-5">
              ...
              <p className="text-sm leading-5 text-gray-900">
                Sed ut perspiciatis unde omnis iste. Lorem ipsum dolor sit amet, consectetur
                adipiscing elit.
              </p>
            </div>
