...
import Blob from '../../images/svg-decorator-blob-8.svg';
...
const HighFeatures = () => {
  return (
    ...
    <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl text-blue-300">
      ...
      <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
        <div>
          <h3 className="text-2xl font-bold tracking-tight sm:text-3xl text-blue-300">
          ...
          <div className="mt-12 space-y-12">
            <div className="flex">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center w-12 h-12 rounded-md bg-blue-300 text-coolGray-50">
                  <svg
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium leading-6 text-blue-300">
        ...
        <div aria-hidden="true" className="mt-10 lg:mt-0">
          <img
            ...
            alt=""
            className="mx-auto rounded-lg shadow-lg bg-coolGray-500"
          />
        </div>
      </div>
      <div>
