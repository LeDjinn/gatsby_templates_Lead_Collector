...
const NormalPricing = () => {
  return (
    // <div class="flex items-center justify-center lg:flex-col items-center justify-center max-w-sm mx-auto">
    //   <div
    ...
    <>
      <div class="text-center mt-12">
        <h1 class="sm:text-3xl text-2xl font-bold title-font text-gray-900 mb-4">Nos produits</h1>
      ...
      <div className="md:flex md:justify-center md:space-x-8 md:px-14">
        <div className="mt-16 py-4 px-4 w-96 bg-blue-800 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 mx-auto md:mx-0">
