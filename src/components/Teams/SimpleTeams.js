      ...
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <span className="relative">Une équipe</span>
          </span>{' '}
          de professionnels passionés et engagés
        </h2>
      ...
      <div className="grid gap-10 row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-3">
        <div className="flex">
          ...
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold text-purple-700">Oliver Aguilerra</p>
        ...
        <div className="flex">
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold text-purple-700">Marta Clermont</p>
        ...
        <div className="flex">
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold text-purple-700">Anthony Geek</p>
        ...
        <div className="flex">
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold text-purple-700">Alice Melbourne</p>
        ...
        <div className="flex">
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold text-purple-700">Martin Garix</p>
        ...
        <div className="flex">
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold text-purple-700">Andrew Larkin</p>
        ...
        <div className="flex">
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold text-purple-700">Sophie Denmo</p>
        ...
        <div className="flex">
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold text-purple-700">Benedict Caro</p>
        ...
        <div className="flex">
          ...
          />
          <div className="flex flex-col justify-center">
            <p className="text-lg font-bold text-purple-700">Adam Molly</p>
