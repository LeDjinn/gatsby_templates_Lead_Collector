      ...
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <span className="relative">Aider</span>
          </span>{' '}
          les entreprises à être compétifif
        </h2>
      ...
      <div className="grid gap-8 row-gap-0 lg:grid-cols-3">
        <div className="relative text-center">
          <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 sm:w-20 sm:h-20">
            <svg
              className="w-12 h-12 text-purple-700 sm:w-16 sm:h-16"
              stroke="currentColor"
              viewBox="0 0 52 52"
            >
              <polygon
          ...
          <h6 className="mb-2 text-2xl font-extrabold">Étape 1</h6>
        ...
        <div className="relative text-center">
          ...
          <h6 className="mb-2 text-2xl font-extrabold">Étape 2</h6>
          <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
        ...
        <div className="relative text-center">
          ...
          <h6 className="mb-2 text-2xl font-extrabold">Étape 3</h6>
          <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
